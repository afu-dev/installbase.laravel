...
{
    public function test_it_parses_censys_apcupsd_data_1(): void
    {
        $parser = new ApcupsdParser();

        $data = file_get_contents("tests/fixtures/parsers/apcupsd/censys_apcupsd_1.json");
    ...
    public function test_it_parses_censys_apcupsd_data_2(): void
    {
        $parser = new ApcupsdParser();

        $data = file_get_contents("tests/fixtures/parsers/apcupsd/censys_apcupsd_2.json");
    ...
    public function test_it_parses_censys_apcupsd_data_3(): void
    {
        $parser = new ApcupsdParser();

        $data = file_get_contents("tests/fixtures/parsers/apcupsd/censys_apcupsd_3.json");
    ...
    public function test_it_parses_censys_apcupsd_data_4(): void
    {
        $parser = new ApcupsdParser();

        $data = file_get_contents("tests/fixtures/parsers/apcupsd/censys_apcupsd_4.json");
    ...
    public function test_it_parses_censys_apcupsd_data_5(): void
    {
        $parser = new ApcupsdParser();

        $data = file_get_contents("tests/fixtures/parsers/apcupsd/censys_apcupsd_5.json");
